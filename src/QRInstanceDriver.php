...
namespace BotMan\Drivers\QRInstance;
...
use BotMan\Drivers\QRInstance\Extras\AttachmentVisitorReply;
use BotMan\Drivers\QRInstance\Extras\TypingIndicator;
...
class QRInstanceDriver extends HttpDriver
{
    const DRIVER_NAME = 'QRInstance';
    ...
    public function buildPayload(Request $request)
    {
        ...
        $this->config = Collection::make($this->config->get('qrinstance', []));
    }
    ...
    {
        // Not available with the QRInstance driver.
    }
