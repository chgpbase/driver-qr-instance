...
class WebDriverTest extends PHPUnit_Framework_TestCase
{
    ...
    public function it_returns_the_driver_name()
    {
        ...
        $this->assertSame('QRinstance', $driver->getName());
    }
    ...
    public function it_returns_images()
    {
        $driver = $this->getDriverWithFiles([
            'driver' => 'qrinstance',
            'userId' => '12345',
            'attachment' => QRInstanceDriver::ATTACHMENT_IMAGE,
        ], [
            'file1' => [
                'name' => 'MyFile.png',
                'type' => 'image/png',
    ...
    public function it_returns_videos()
    {
        $driver = $this->getDriverWithFiles([
            'driver' => 'qrinstance',
            'userId' => '12345',
            'attachment' => QRInstanceDriver::ATTACHMENT_VIDEO,
        ], [
            'file1' => [
                'name' => 'MyFile.png',
                'type' => 'image/png',
    ...
    public function it_returns_audio()
    {
        $driver = $this->getDriverWithFiles([
            'driver' => 'qrinstance',
            'userId' => '12345',
            'attachment' => QRInstanceDriver::ATTACHMENT_AUDIO,
        ], [
            'file1' => [
                'name' => 'MyFile.png',
                'type' => 'image/png',
    ...
    public function it_returns_files()
    {
        $driver = $this->getDriverWithFiles([
            'driver' => 'qrinstance',
            'userId' => '12345',
            'attachment' => QRInstanceDriver::ATTACHMENT_FILE,
        ], [
            'file1' => [
                'name' => 'MyFile.png',
                'type' => 'image/png',
